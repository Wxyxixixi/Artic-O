...
class AffineProbPath(ProbPath):
    ...
    def sample(self, x_0: Tensor, x_1: Tensor, t: Tensor, return_alpha_sigma=False) -> PathSample:
        ...
        if return_alpha_sigma:
            return PathSample(
                x_t=x_t, dx_t=dx_t, x_1=x_1, x_0=x_0, t=t), alpha_t, sigma_t
        else:
